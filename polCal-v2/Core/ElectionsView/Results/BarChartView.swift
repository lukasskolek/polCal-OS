...
struct BarChartView: View {
    ...
    //to help determine whether crown next to inGovernment parties is gold or gray
    ...
    var body: some View {
        VStack {
            Chart {
                ...
                ForEach(scenarioModel.parties?.sorted(by: { $0.votes > $1.votes }) ?? [], id: \.name) { party in
                    // Bar for Votes
                    BarMark(
                    ...
                    .foregroundStyle(
                        ...
                        Color(red: party.red, green: party.green, blue: party.blue, opacity: party.opacity) :
                            Color(red: party.red, green: party.green, blue: party.blue, opacity: party.opacity * 0.5)
                    )
                ...
                RuleMark(y: .value("Threshold", 5.0))
                    ...
                    .zIndex(-1.0)
                    .annotation(position: .trailing) {Text("5").font(.caption)
...
struct BarChartView_Previews: PreviewProvider {
    static var previews: some View {
        ...
        let mockParties = [
            ...
            Party(name: "Party D", votes: 7.0, coalitionStatus: .smallCoal, mandaty: 5, zostatok: 0, inGovernment: false, red: 0.567, blue: 0.24, green: 0.920, opacity: 1.0),
            Party(name: "Party B", votes: 3.0, coalitionStatus: .smallCoal, mandaty: 0, zostatok: 0, inGovernment: false, red: 0.567, blue: 0.24, green: 0.920, opacity: 1.0),
            Party(name: "Party C", votes: 8.0, coalitionStatus: .smallCoal, mandaty: 25, zostatok: 0, inGovernment: true, red: 0.17, blue: 0.024, green: 0.11, opacity: 1.0)
        ]
